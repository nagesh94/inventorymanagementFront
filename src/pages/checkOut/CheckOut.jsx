            ...
            <div className="mainContainer">
                ...
                <div className="main">
                    ...
                    <div className="customerForm">
                        ...
                        <input type="number" placeholder='name' name='phone' required onChange={changeHandler} />
                        <input type="email" placeholder='name' name='email' required onChange={changeHandler} />
                        <button onClick={submit} >pay</button>
                    </div>
                    <button onClick={() => close(false)}>cancel order</button>
